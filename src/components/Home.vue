...
.nav {
  ...
  width: 100%;
  background-color: rgba(244, 177, 150, 0);
  z-index: 1;
}

.showNav {
  transition: all 1s ease;
  background-color: rgba(244, 177, 150, 1);
}
...
.navButtons > h3:active {
  border-bottom: 4px solid #f4b196;
}
...
@media (max-width: 800px) {
  ...
  .nav {
    overflow: hidden;
    height: 70px;
    transition: height 600 ease-in-out;
  }
